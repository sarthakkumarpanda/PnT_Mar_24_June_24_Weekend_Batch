package com.automation.Day21_26th_May_2024_WebTables;
...
public class Class_Assignment {
	...
	public void assignment2() {
		...
		driver.manage().window().maximize();
		driver.get("https://money.rediff.com/gainers/bse/daily/groupall");
		WebElement nineNintyNinthEntity = driver
				.findElement(By.xpath("//table[@class = 'dataTable']/tbody/tr[999]/td[4]"));
